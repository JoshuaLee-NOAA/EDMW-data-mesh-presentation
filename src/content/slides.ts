...
export const presentationConfig: PresentationConfig = {
  ...
  slides: [
    ...
    },
    {
      id: "slide-9",
      type: "split",
      title: "The Broader Cloud Estate",
      subtitle: "Domains run more than just data products. Their placement involves a fundamental organizational choice.",
      category: "BEYOND DATA PRODUCTS",
      bullets: [
        "Pipelines (PL): Ingestion, transformation, and ML inference at scale using Cloud Dataflow, Storage, and Build.",
        "Applications (AP): Consumer-facing APIs, dashboards, and field data collection tools (Cloud Run, Looker Studio).",
        "Science Environments (SC): Exploration and statistical modeling workspaces where scientists prototype analyses.",
        "HPC Workloads (HP): Compute-intensive workloads that require specialized infrastructure beyond standard processing.",
        "AI at Scale: Treating data products as curated training sources to enable enterprise-wide machine learning.",
        "The Organizational Choice: Domain-Coupled favors simplicity (single IAM/team), while Domain-Separated favors specialization (clean boundaries). Choose based on tolerance for cross-team coordination."
      ],
      emphasizeBulletIndices: [5],
      mediaType: "diagram",
      mediaDiagramId: "ResourceHierarchy",
    },
    {
      id: "slide-10",
      type: "metrics",
      ...
      metrics: [
        {
          id: "m-1",
          value: "1",
          label: "Work with, not against, Conway's Law.",
          description: "Regional autonomy is a feature, not a bug. Aligning technical architecture with MSA statutory domains ensures we build systems that match how our organization actually operates.",
          badgeColor: "skygold",
        },
        {
          id: "m-2",
          value: "2",
          label: "Treat data as a product, curated, not hoarded.",
          description: "Data must be actively managed with explicit contracts, discoverability, and SLA guarantees, abstracting away the friction of traditional data silos.",
          badgeColor: "seagrass",
        },
        {
          id: "m-3",
          value: "3",
          label: "Enforce policies with code, not committees.",
          description: "Security and confidentiality rules are baked directly into the platform provisioning process—enforcing compliance through code rather than manual gatekeeping.",
          badgeColor: "noaa",
        },
        {
          id: "m-4",
          value: "4",
          label: "Build for the entire cloud estate.",
          description: "Data products are just the foundation. These exact same mesh patterns scale seamlessly to govern pipelines, applications, and AI workloads.",
          badgeColor: "coral",
        },
      ],
      summaryNote: "Georgetown University | MTPM 5750-1 (Enterprise Mod.) | MTPM/MPIT 6656-01 (Cloud Computing) | Disclaimer: Views expressed are my own and do not represent official NOAA Fisheries policy.",
    },
  ],
};
